...
import type { MatchContextResult } from './match-context';
...
export type AdvancedModelOutput={expectedGoals:[number,number];homeStrength:TeamStrength;awayStrength:TeamStrength;homeForm:FormRating;awayForm:FormRating;homeElo:number;awayElo:number;votes:ConsensusVote[];consensusOutcome:Outcome;consensusCount:number;impacts:PredictionImpact[];modelAgreement:number;formStability:number;eloReliability:number;leaguePredictability:number;context:MatchContextResult};
