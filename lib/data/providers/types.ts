...
export type ProviderReport={name:string;kind:'fixtures'|'odds'|'statistics';state:ProviderState;matches:number;note?:string};
export type DataHealth = { requestedMode: ProviderMode; mode: ProviderMode; state: ProviderState; fixture: string; statistics: string; odds: string; updatedAt: string; stale: boolean; cacheUsed: boolean; warnings: string[]; providers?:ProviderReport[] };
